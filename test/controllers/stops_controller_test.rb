...
class StopsControllerTest < ActionController::TestCase
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post :create, stop: { line_number: @stop.line_number, ritual: @stop.ritual, ritual_deity: @stop.ritual_deity, type_of_stop: @stop.type_of_stop }
    end
  ...
  test "should update stop" do
    patch :update, id: @stop, stop: { line_number: @stop.line_number, ritual: @stop.ritual, ritual_deity: @stop.ritual_deity, type_of_stop: @stop.type_of_stop }
    assert_redirected_to stop_path(assigns(:stop))
  end
